...
void checarColisiones() {
	...
	//Orilla der del triangulo es mayor que la orilla izq del cuadrado
	if (posXTriangulo + 0.15 >= posXCuadrado - 0.15
		//orilla izq triangulo es menor que la orilla der del cuadrado
		&& posXTriangulo - 0.15 <= posXCuadrado + 0.15 &&
		//orilla sup triangulo > que orilla infe del cuadrado
		posYCuadrado + 0.15 >= posYTriangulo - 0.15 && 
		posYCuadrado - 0.15 <= posYTriangulo + 0.15) {
		rojoTriangulo = 0.0f;
		verdeTriangulo = 0.0f;
		azulTriangulo = 0.0f;
